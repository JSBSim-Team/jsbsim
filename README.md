...
The Python module of JSBSim is licensed under the [GPL 3.0 license](https://opensource.org/licenses/GPL-3.0). The license file is included in the source code file[python/COPYING](https://github.com/JSBSim-Team/jsbsim/blob/master/python/COPYING).
