...
static const char *IdSrc = "$Header: /cvsroot/jsbsim/JSBSim/Attic/FGTurboJet.cpp,v 1.5 2000/11/22 23:49:02 jsb Exp $";
...
FGTurboJet::FGTurboJet(FGFDMExec* exec, FGConfigFile* cfg) :
                                 FGEngine(exec)
{
  //
}
