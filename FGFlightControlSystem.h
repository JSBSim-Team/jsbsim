...
public: 
	...
	//generic
	inline void  SetFCSControl(int which, float tt, int n=0) { controls[which]=tt; }
	inline float GetFCSControl(const int which, int n=0) { return controls[which]; }
	
	inline float GetFCSSurface(const int which, int n=0) { return surfaces[which]; }
	inline void  SetFCSSurface(const int which, float tt, int n=0) { surfaces[which]=tt; }
