...
In the example of \autoref{fig:Cm_delta:e}, the pitch moment due to elevator (linearly dependent on its deflection $\delta_{\mathrm{e}}$) is defined in terms of a control power coefficient $C_{m\delta_\mathrm{e}}$, which is a function of Mach number $M_{\infty}$.
