...
#define ID_PROPELLER "$Header: /cvsroot/jsbsim/JSBSim/Attic/FGPropeller.h,v 1.8 2001/02/02 01:17:00 jsb Exp $"
...
/** Propeller modeling class.
    ...
    <ul>
    @author Jon S. Berndt
    @version $Id: FGPropeller.h,v 1.8 2001/02/02 01:17:00 jsb Exp $
    @see FGEngine
    @see FGThruster
    @see FGTable
*/
