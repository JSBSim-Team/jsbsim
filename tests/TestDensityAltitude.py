...
class TestDensityAltitude(JSBSimTestCase):
    ...
    def test_densityaltitude(self):
        ...
        reference_data = [
            (0,        0,   0),
            (0,      -27,  -1838.3244287232005),
            (0,       27,   1724.0746953728578),
            (10000,    0,   10000),
            (10000,  -27,   8842.638616820248),
            (10000,   27,   11117.884358863219),
            (20000,    0,   20000),
            (20000,  -27,   19524.299812417208),
            (20000,   27,   20511.14751673466),
            (30000,    0,   30000),
            (30000,  -27,   30206.659226520693),
            (30000,   27,   29903.864216687543)
            ]
