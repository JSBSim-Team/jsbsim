...
public:
  ...
  void testLoadWithNumericPrefix() {
    ...
    FGTable t_2x1(pm.get(), el_table, "2");
    TS_ASSERT_EQUALS(t_2x1.GetNumRows(), 2);
  ...
  void testLoadWithStringPrefix() {
    ...
    FGTable t_2x1(pm.get(), el_table, "tables");
    TS_ASSERT_EQUALS(t_2x1.GetNumRows(), 2);
...
public:
  ...
  void testLoadWithNumericPrefix() {
    ...
    FGTable t_2x2(pm.get(), el_table, "2");
    TS_ASSERT_EQUALS(t_2x2.GetNumRows(), 2);
  ...
  void testLoadWithStringPrefix() {
    ...
    FGTable t_2x2(pm.get(), el_table, "tables");
    TS_ASSERT_EQUALS(t_2x2.GetNumRows(), 2);
...
public:
  ...
  void testCopyConstructor() {
    ...
    Element_ptr elm = readFromXML("<dummy>"
                                  ...
                                  "</dummy>");
    Element* el_table = elm->FindElement("table");
    auto ref = std::make_shared<FGTable>(pm.get(), el_table);
...
public:
  ...
  void testUnexpectedPrefix() {
    ...
    TS_ASSERT_THROWS(FGTable t_2x1(pm.get(), el_table, "0"), BaseException&);
  }
  ...
  void test1DBadNumberOfColumns() {
    ...
    TS_ASSERT_THROWS(FGTable t_4x1(pm.get(), el_table), BaseException&);
    ...
    TS_ASSERT_THROWS(FGTable t_1x1(pm.get(), el_table), BaseException&);
    ...
    TS_ASSERT_THROWS(FGTable t_1x2(pm.get(), el_table), BaseException&);
