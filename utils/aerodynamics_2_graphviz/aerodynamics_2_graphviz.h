...
public :
  ...
  void graph_jsbsim_fdm_aerodynamics(std::shared_ptr<JSBSim::FGFDMExec> fdm, const std::string output_filename="");
  void add_function_edges(int axis_index, gvpp::SubGraph<>* graph, const JSBSim::FGFunction* function);
