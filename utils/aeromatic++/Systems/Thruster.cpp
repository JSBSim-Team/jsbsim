    ...
    _diameter(8)
{
    ...
    _inputs.push_back(new Param("Propeller diameter", &_diameter));
    _inputs.push_back(new Param("Is the propeller fixed ptich?", &_fixed_pitch));
}
...
std::string Propeller::thruster()
{
    ...
    file << "<!-- Generated by Aero-Matic v $version" << std::endl;
    file << std::endl;
    file << "     Inputs:" << std::endl;
    file << "                horsepower: " << _engine->_power << std::endl;
    if(_fixed_pitch) {
        file << "                     pitch: fixed" << std::endl;
    } else {
        file << "                     pitch: variable" << std::endl;
    }
