...
static const char *IdSrc = "$Header: /cvsroot/jsbsim/JSBSim/Attic/FGTurboProp.cpp,v 1.1 2000/11/21 05:48:09 jsb Exp $";
...
FGTurboProp::FGTurboProp(FGFDMExec* fdex, string enginePath, string engineName, int num) :
