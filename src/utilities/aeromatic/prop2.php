...
if($ac_pitch == 0) {          // fixed pitch
 print("  <function name=\"C_THRUST\">\n");
 print("    <table>\n");
 print("      <independentVar>propulsion/advance-ratio</independentVar>\n");
 print("      <tableData>\n");
 printf("       0.0  %5.4f\n", $ct0 * 1.0);
 printf("       0.1  %5.4f\n", $ct0 * 0.959);
 printf("       0.2  %5.4f\n", $ct0 * 0.917);
 ...
 print("  <function name=\"C_THRUST\">\n");
 print("    <table>\n");
 print("      <independentVar lookup=\"row\">propulsion/advance-ratio</independentVar>\n");
 print("      <independentVar lookup=\"column\">propulsion/blade-angle</independentVar>\n");
 print("      <tableData>\n");
 print("                12         30\n");
 $ct30 = $ct0 + 0.04;
