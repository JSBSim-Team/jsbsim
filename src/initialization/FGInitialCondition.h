...
#define ID_INITIALCONDITION "$Id: FGInitialCondition.h,v 1.19 2009/10/02 10:30:08 jberndt Exp $"
...
/** Initializes the simulation run.
   ...
   @author Tony Peden
   @version "$Id: FGInitialCondition.h,v 1.19 2009/10/02 10:30:08 jberndt Exp $"
*/
